...
def get_app_state() -> tuple[AppState, Prompts, AgentSpec]:
    ...
    # Patch httpx globally so RemoteA2aAgent's internal client propagates traceparent headers.
    HTTPXClientInstrumentor().instrument()
    return app, Prompts(greeting=cast(PromptCard, app.service["greeting_agent"])), agent_spec
