use pyo3::prelude::*;
use scouter_client::{
    flush_tracer, get_current_active_span, get_function_type, init_tracer, shutdown_tracer,
    ActiveSpan, BaseTracer, BatchConfig, ExportConfig, FunctionType, GrpcConfig, GrpcSpanExporter,
    HttpSpanExporter, OtelHttpConfig, OtelProtocol, SpanKind, StdoutSpanExporter, TestSpanExporter,
