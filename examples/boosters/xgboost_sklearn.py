...
class OpsmlXGBoostPipelineWorkflow:
    ...
    def _create_xgboost_modelcard(self):
        """This is an arbitrary example of how to create a modelcard for a xgboost model only
        Notice we use the XGBoostModel interface
        """
    ...
    def run_workflow(self):
        ...
        self._create_xgboost_modelcard()
