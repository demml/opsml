...
class DataCard(ArtifactCard):
    ...
    Args:
        ...
        drift_report:
            Optional drift report generated by Drifter class
        dependent_vars:
        ...
        drift_uri:
            Location where drift report is stored
        version:
            DataCard version
        feature_map:
...
class RunCard(ArtifactCard):
    ...
    Args:
        ...
        modelcard_uids:
            Optional List of ModelCard uids to associate with this experiment
        pipelinecard_uid:
        ...
        artifact_uris:
            Optional dictionary of artifact uris associated with experiment artifacts.
        uid:
            Unique id (assigned if card has been registered)
        version:
            Current version (assigned if card has been registered)
