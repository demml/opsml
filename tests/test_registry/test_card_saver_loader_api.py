...
def _test_save_huggingface_modelcard_api_client(
...
def _test_save_torch_modelcard_api_client(
...
def _test_save_torch_lightning_modelcard_api_client(
...
def test_save_tensorflow_modelcard_api_client(
    load_transformer_example: TensorFlowModel,
    api_storage_client: client.StorageClientBase,
):
    model: TensorFlowModel = load_transformer_example
