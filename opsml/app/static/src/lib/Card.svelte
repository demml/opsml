...
<a class= "block border card p-4 z-10 bg-slate-50 rounded-2xl w-full { hoverColor } hover:border-solid hover:border {hoverBorderColor}" href="/opsml/{registry}/card/home?name={name}&repository={repository}&version={version}">
