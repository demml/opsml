<script lang="ts">
  ...
  import { faTag, faIdCard, faFolderOpen, faFolderTree, faCodeBranch, faBolt, faGears } from '@fortawesome/free-solid-svg-icons'
    ...
    <div class="pt-2 ">
      <TabGroup 
        ...
        >
          ...
          <Tab bind:group={tabSet} name="versions" value="settings" on:click={() => showTabContent("settings")}>
            <div class="flex flex-row  items-center">
