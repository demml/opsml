...
<div class="flex flex-col">
  ...
  <div class="flex-none sticky top-14 z-10 border-b-2 border-black bg-surface-100 pb-2 pt-2">
    <div class="flex justify-center items-center w-11/12 mx-auto gap-4">
      ...
      {#if userStore.favorite_spaces.includes(spaceRecord.space)}
        <button class="btn text-sm bg-primary-500 rounded-lg justify-self-center text-black ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 border-black border-2 border-border reverse-shadow-hover" 
          onclick={unfavoriteSpace}>Unfavorite
        </button>
      {:else}
        <button class="btn text-sm bg-surface-50 rounded-lg justify-self-center text-black ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 border-black border-2 border-border shadow shadow-hover" 
  ...
  <div class="flex-1 pb-10">
    ...
    {:then cards}
      ...
      <div class="mx-auto w-9/12 justify-center px-4 py-4">
