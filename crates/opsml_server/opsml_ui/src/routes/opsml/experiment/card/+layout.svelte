  ...
  <div class="flex-none pt-16 pb-1 border-b-2 border-black bg-slate-100">
    <div class="flex flex-col mx-auto flex w-11/12 justify-start">
      ...
      <div class="flex flex-row gap-x-4 text-black pl-4 h-8 mb-1 text-smd">
        ...
        <button class="flex items-center gap-x-2 border-b-3 {data.activeTab === 'plots' ? 'border-secondary-500' : 'border-transparent'} hover:border-secondary-500 hover:border-b-3" onclick={() => navigateTab('plots')}>
          <ChartColumnDecreasing color="#8059b6"/>
          <span>Plots</span>
        </button>
        <button class="flex items-center gap-x-2 border-b-3 {data.activeTab === 'hardware' ? 'border-secondary-500' : 'border-transparent'} hover:border-secondary-500 hover:border-b-3" onclick={() => navigateTab('hardware')}>
