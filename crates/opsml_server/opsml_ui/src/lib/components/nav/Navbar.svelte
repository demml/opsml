  ...
  <div class="mx-auto flex w-[1300px] max-w-full items-center justify-between">
    ...
    <div class="flex items-center gap-5 m1000:gap-5">
      <div class="flex items-center justify-end gap-5 m800:w-[unset] m400:gap-3">
        <a target="_blank" aria-label="Close" href="/" class="m800:hidden flex gap-2 items-center justify-center rounded-base border-2 border-border shadow p-2 transition-all hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none bg-surface-50">
