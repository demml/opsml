<script lang="ts">
  import type { AgentEvalConfig, AgentEvalProfile, EvalRecordPaginationResponse, AgentEvalWorkflowPaginationResponse } from '../types';
  import type { AgentMonitoringPageData } from '../../dashboard/utils';
  ...
  import AgentConfigHeader from '../AgentConfigHeader.svelte';
  import EvalRecordTable from '../record/EvalRecordTable.svelte';
  import AgentEvalWorkflowTable from '../workflow/AgentEvalWorkflowTable.svelte';
  import VizBody from '$lib/components/scouter/dashboard/VizBody.svelte';
  import AgentTaskAccordion from '../task/AgentTaskAccordion.svelte';
...
<div class="mx-auto w-full px-4 sm:px-6 lg:px-8 space-y-8 pb-12">
  ...
  <AgentTaskAccordion tasks={profile.tasks} />
          ...
          {#if currentMetricData}
            {#key currentMetricName}
              <VizBody
                ...
                currentDriftType={DriftType.Agent}
        ...
        <div class="p-2 w-full flex-grow bg-slate-50 min-h-0">
            {#key workflows}
                <AgentEvalWorkflowTable
                  currentPage={workflows as AgentEvalWorkflowPaginationResponse}
