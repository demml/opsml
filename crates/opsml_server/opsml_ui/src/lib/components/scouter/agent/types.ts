 ...
 */
export interface AgentEvalWorkflowPaginationResponse {
  items: AgentEvalWorkflowResult[];
  has_next: boolean;
  next_cursor?: RecordCursor;
  has_previous: boolean;
  previous_cursor?: RecordCursor;
 ...
 */
export interface AgentEvalTaskResponse {
  tasks: EvalTaskResult[];
}

/** Request interface for AgentEvalTask */
export interface AgentEvalTaskRequest {
  record_uid: string;
}
