...
<div class="flex flex-col h-full">
  {#if alerts.length === 0}
    <div class="flex items-center justify-center flex-1 text-center text-gray-500 text-2xl text-primary-500 font-bold">
      ...
      <table class="w-full text-black text-sm md:text-base bg-slate-100">
        ...
        <tbody>
          ...
          <tr class="border-t hover:bg-primary-300 py-2">
            ...
            <td class="p-2 text-center" ><AlertModal code={alert.alert} /></td>
