...
export class OpsmlClient {
  ...
  async login(username: string, password: string): Promise<boolean> {
    this.updateUser("foo", "bar");
    return true;
  }

  async switch(username: string, password: string): Promise<boolean> {
    // inject username into string
    console.log("switching user: " + username);

    this.updateUser("blah", "bar");

    console.log("switched user: " + this.username);
    return true;
  }
...
export const testOpsmlClient = new OpsmlClient();
