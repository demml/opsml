use crate::{postgres::helper::PostgresQueryHelper, traits::SpaceLogicTrait};
...
#[derive(Debug, Clone)]
pub struct SpaceLogicPostgresClient {
    pool: sqlx::Pool<Postgres>,
}
impl SpaceLogicPostgresClient {
...
#[async_trait]
impl SpaceLogicTrait for SpaceLogicPostgresClient {
