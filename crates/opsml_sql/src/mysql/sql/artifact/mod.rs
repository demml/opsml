use crate::{mysql::helper::MySqlQueryHelper, traits::ArtifactLogicTrait};
...
#[derive(Debug, Clone)]
pub struct ArtifactLogicMySqlClient {
    pool: sqlx::Pool<MySql>,
}
impl ArtifactLogicMySqlClient {
...
#[async_trait]
impl ArtifactLogicTrait for ArtifactLogicMySqlClient {
