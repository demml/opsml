...
This directory contains various technical specifications for the OpsML project. It is an on-going effort to document the architecture, design decisions, changes, and other important aspects of the project. It is **NOT** feature complete and is subject to change as the project evolves.
